    ...
    public var dnf: Formula {
          ...
          case .conjunction(let b, let c):
            ...
            case (_, .disjunction(let d, let e)):
              return ((d.dnf && b.dnf).dnf || (e.dnf && b.dnf).dnf).dnf
              // On applique à gauche
            case (.disjunction(let d, let e), _):
              return ((d.dnf && c.dnf).dnf || (e.dnf && c.dnf).dnf).dnf
              // On applique à droite
            default:
              return b.dnf && c.dnf
            }
          default:
    ...
    public var cnf: Formula {
        ...
        case .disjunction(let a, let b):
          ...
          case (_, .conjunction(let c, let d)):
            return ((c.cnf || a.cnf).cnf && (d.cnf || a.cnf).cnf).cnf
            // On applique à gauche
          case (.conjunction(let c, let d),_):
            return ((c.cnf || b.cnf).cnf && (d.cnf || b.cnf).cnf).cnf
            // On applique à droite
          default:
            return a.cnf || b.cnf
          }
